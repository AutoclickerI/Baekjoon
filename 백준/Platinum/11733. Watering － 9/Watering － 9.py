    ...
    for x in range(W):
        ...
        if empty%3==1:
            if is_valid(start_pos_y,start_pos_x+7):
                for dy in[0,4,2]:
                    if all(i=='.'for i in[v[start_pos_y+dy][start_pos_x+4],v[start_pos_y+dy][start_pos_x+6],v[start_pos_y+dy][start_pos_x+7]])and v[start_pos_y+dy-1][start_pos_x+6:start_pos_x+8]!=['.','#']:
                        v[start_pos_y+dy][start_pos_x+4]=v[start_pos_y+dy][start_pos_x+6]=v[start_pos_y+dy][start_pos_x+7]='xz'['z'not in[v[start_pos_y+dy-1][start_pos_x+6],v[start_pos_y+dy][start_pos_x+8]]]
                        v[start_pos_y+dy][start_pos_x+5]='_'
                        flag=0
                        break
            if flag and is_valid(start_pos_y+7,start_pos_x):
                for dx in[0,4,2]:
                    if all(i=='.'for i in[v[start_pos_y+4][start_pos_x+dx],v[start_pos_y+6][start_pos_x+dx],v[start_pos_y+7][start_pos_x+dx]]):
                        v[start_pos_y+4][start_pos_x+dx]=v[start_pos_y+6][start_pos_x+dx]=v[start_pos_y+7][start_pos_x+dx]='xz'['z'!=v[start_pos_y+4][start_pos_x+dx-1]]
            ...
            if flag:
                raise
        if empty%3==2:
            if is_valid(start_pos_y,start_pos_x+6):
                for dy in[0,4,2]:
                    if all(i=='.'for i in[v[start_pos_y+dy][start_pos_x+4],v[start_pos_y+dy][start_pos_x+6],v[start_pos_y+dy][start_pos_x+3]])and v[start_pos_y+dy-1][start_pos_x+6:start_pos_x+8]!=['.','#']:
                        ...
                        flag=0
                        break
            if flag and is_valid(start_pos_y+6,start_pos_x):
                for dx in[0,4,2]:
                    if all(i=='.'for i in[v[start_pos_y+4][start_pos_x+dx],v[start_pos_y+6][start_pos_x+dx],v[start_pos_y+3][start_pos_x+dx]]):
                        v[start_pos_y+4][start_pos_x+dx]=v[start_pos_y+6][start_pos_x+dx]=v[start_pos_y+3][start_pos_x+dx]='xz'['z'!=v[start_pos_y+4][start_pos_x+dx-1]]
                        v[start_pos_y+5][start_pos_x+dx]='_'
                        flag=0
                        break
            if flag:

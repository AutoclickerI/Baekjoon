...
<ul>
<li>One line with two integers $c$ and $n$ ($0\leq c, n\leq 10^9$), the number of BAPC coins in Old MacDonald's cup and the number of coins that you have.</li>
</ul>
